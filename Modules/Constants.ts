...
export const PROJECT_NAME = process.env.PROJECT_NAME ?? "StarBone"; // Default prefix for the logger module.
...
export const PORT = process.env.PORT ?? 300; // Port for the server to run on.
